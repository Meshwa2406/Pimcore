...
#[Route(name: 'pimcore_bundle_seo_misc_')]
class MiscController extends UserAwareController
{
    use JsonHelperTrait;

    #[Route(path: '/http-error-log', name: 'httperrorlog', methods: ['POST'])]
    ...
    #[Route(path: '/http-error-log-detail', name: 'httperrorlogdetail', methods: ['GET'])]
    ...
    #[Route(path: '/http-error-log-flush', name: 'httperrorlogflush', methods: ['DELETE'])]
