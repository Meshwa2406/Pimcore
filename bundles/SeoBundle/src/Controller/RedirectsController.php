 ...
 * @internal
 */
#[Route(path: '/redirects', name: 'pimcore_bundle_seo_redirects_')]
class RedirectsController extends UserAwareController
{
    use JsonHelperTrait;

    #[Route(path: '/list', name: 'redirects', methods: ['POST'])]
    ...
    #[Route(path: '/csv-export', name: 'csvexport', methods: ['GET'])]
    ...
    #[Route(path: '/csv-import', name: 'csvimport', methods: ['POST'])]
    ...
    #[Route(path: '/get-statuscodes', name: 'statuscodes', methods: ['GET'])]
